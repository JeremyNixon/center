...
<p>
But the classic definition of distance is Euclidean distance - the straight line distance between two standards. 
</p>
...
<p>
	...
	Then, with points assigned to the closest centers, the means are adjusted. They become the mean of the points currently assigned to that cluster.
</p>
...
<p>
	Now that we've assigned points to means, we want to adjust the means to become the center of the points attached to them.
</p>
<div style="background: #272822; overflow:auto;width:auto; border-width:.1em .1em .1em .8em;padding:.2em .6em;"><pre style="margin: 0; line-height: 125%">
